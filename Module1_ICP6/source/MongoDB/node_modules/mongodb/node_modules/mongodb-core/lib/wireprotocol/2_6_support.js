...
var copy = require('mongodb-core/lib/connection/utils').copy,
  retrieveBSON = require('mongodb-core/lib/connection/utils').retrieveBSON,
  KillCursor = require('mongodb-core/lib/connection/commands').KillCursor,
  GetMore = require('mongodb-core/lib/connection/commands').GetMore,
  Query = require('mongodb-core/lib/connection/commands').Query,
  f = require('util').format,
  MongoError = require('mongodb-core/lib/error').MongoError,
  getReadPreference = require('mongodb-core/lib/wireprotocol/shared').getReadPreference;
