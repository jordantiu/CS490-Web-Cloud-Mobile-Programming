...
var inherits = require('util').inherits,
  ...
  errors = require('mongodb-core/lib/error'),
  Server = require('mongodb-core/lib/topologies/server'),
  ReplSetState = require('mongodb-core/lib/topologies/replset_state'),
  clone = require('mongodb-core/lib/topologies/shared').clone,
  Timeout = require('mongodb-core/lib/topologies/shared').Timeout,
  Interval = require('mongodb-core/lib/topologies/shared').Interval,
  ...
  isRetryableWritesSupported = require('mongodb-core/lib/topologies/shared').isRetryableWritesSupported,
  getNextTransactionNumber = require('mongodb-core/lib/topologies/shared').getNextTransactionNumber;

var MongoCR = require('mongodb-core/lib/auth/mongocr'),
  ...
  SSPI = require('mongodb-core/lib/auth/sspi'),
