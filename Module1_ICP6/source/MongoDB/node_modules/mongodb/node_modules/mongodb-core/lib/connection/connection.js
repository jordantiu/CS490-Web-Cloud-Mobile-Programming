...
var inherits = require('util').inherits,
  ...
  parseHeader = require('mongodb-core/lib/wireprotocol/shared').parseHeader,
  decompress = require('mongodb-core/lib/wireprotocol/compression').decompress,
  Response = require('mongodb-core/lib/connection/commands').Response,
  MongoNetworkError = require('mongodb-core/lib/error').MongoNetworkError,
  Logger = require('mongodb-core/lib/connection/logger'),
  OP_COMPRESSED = require('mongodb-core/lib/wireprotocol/shared').opcodes.OP_COMPRESSED,
