...
var common = require('mongodb/lib/bulk/common'),
  utils = require('mongodb/lib/utils'),
  ...
  executeOperation = require('mongodb/lib/utils').executeOperation,
  BulkWriteError = require('mongodb/lib/bulk/common').BulkWriteError;
